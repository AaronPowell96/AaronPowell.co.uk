<div id="navBar" class = "nav_container">
        ...
        <ul class = "menunav">
            <div class="topnav" id="myTopnav">
                <a href="#home" onclick="homeClick()">AaronPowell</a>
                <a href="#home" onclick="homeClick()">Home</a>
                <a href="#aboutTarget" onclick="aboutme()">About</a>
                <a href = "#projectsTarget" onclick="projectsClick()">Projects</a>
